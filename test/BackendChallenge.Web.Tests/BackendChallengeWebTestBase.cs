...
{
    public abstract class BackendChallengeWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static BackendChallengeWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(BackendChallengeWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<BackendChallengeDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<BackendChallengeDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<BackendChallengeDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<BackendChallengeDbContext, Task<T>> func)
        {
            T result;
